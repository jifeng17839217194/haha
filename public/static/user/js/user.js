...
var user_store_id=$.cookie('user_store_id');
 ...
 function clear_cookie()
{
    ...
    $.cookie('user_realname', null,
    {
        path: '/'
    });

    $.cookie('user_role_cn', null,
    {
        path: '/'
    });
    
    $.cookie('user_store_id', null,
    {
        path: '/'
    });
    
    $.cookie('user_refund_auth', null,
    {
        path: '/'
    });
