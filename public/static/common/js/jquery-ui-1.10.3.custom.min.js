...
$(document).ready(function(e) {
    if ($(".sortable").size() > 0) {
        sys_open_paixi($(".sortable ul"));
    }
});

function sys_open_paixi(jqueryboj) {
    jqueryboj.sortable({
        ...
        update: function() {
            /*ddddid="";
            $("#step_2_box").find("li").each(function(index, element) {
            	ddddid+=","+$(this).attr("date");
            });
            writeCookie("myitemlist", ddddid, 24);
            showmyitemlist2();*/
        }
    });
    jqueryboj.disableSelection();
}